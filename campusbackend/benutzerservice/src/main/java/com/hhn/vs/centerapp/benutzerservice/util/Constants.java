package com.hhn.vs.centerapp.benutzerservice.util;

public final class Constants {
	public final class SwaggerConfig {
		public static final String TITLE = "HHNCenterApp User REST API";
		...
		public static final String CONTACT_NAME = "Friedrich Greiner";
		public static final String CONTACT_EMAIL = "fgreiner@stud.hs-heilbronn.de";
